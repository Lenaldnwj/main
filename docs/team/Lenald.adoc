...
cherBook is targeted at teachers as it offers various features that can improve the lives of teachers.
...
In this project portfolio, the external and internal behavior of the various features, along with the motivations
behind implementing them, will be explained in detail.
