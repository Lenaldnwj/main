...
== Introduction
In this project portfolio, you will be introduced to the `external` and `internal` behavior of the various features of `cherBook`. The `motivations`
...
* Update AboutUs section (Pull request https://github.com/CS2103AUG2017-T16-B2/main/pull/25[#25])
* Create Glossary section (Pull request https://github.com/CS2103AUG2017-T16-B2/main/pull/16[#16])
