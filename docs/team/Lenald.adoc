...
== Introduction to cherBook
cherBook is an address book application that combines statistical analysis with the ease of communication.
CherBook is targetted at teachers as it offers various functionalities that a teacher needs.
...
* Included ParentPhone attribute (Pull requests https://github.com/CS2103AUG2017-T16-B2/main/pull/116[#116])
* Icon text descriptors on startup of cherBook (Pull requests https://github.com/CS2103AUG2017-T16-B2/main/pull/121[#121])
...
* Remove unused codes to improve coveralls (https://github.com/CS2103AUG2017-T16-B2/main/pull/129[#129])
