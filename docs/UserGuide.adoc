...
//TODO: Celine can add explanations for this
...
The statistics automatically changes whenever there is a change to the list of students in the `Students Panel`.
...
* View the grades of the currently selected student's class in the `Graph Panel`
//TODO: uhm celine...
...
* Select between two graphs: Line graph or Bar chart, to see the statistics of the currently selected person's class
